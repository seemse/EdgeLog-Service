简体中文 | [English](./README_en.md) | [官网](https://www.seemse.com) | [文档](https://www.seemse.com)
...
想要进一步了解EdgeLog管理系统，您可以访问[EdgeLog](https://www.seemse.com)的官方网站。
...
体验EdgeLog开源版在线[演示系统](https://www.seemse.com)。
...
如想在本地安装试用完整的系统，可[下载](https://www.seemse.com)完整的前后端安装程序。

## API文档

了解系统详细API，可以访问[EdgeLog API](https://www.seemse.com)。

## 安装、操作与帮助

请遵循[安装文档](https://www.seemse.com)以安装EdgeLog，有关操作手册及帮助文档，请阅读[文档&帮助](https://www.seemse.com)。

## 专业支持

我们根据市场和企业需要，不断迭代，也乐意基于场景特殊性提供专业定制服务。如有需要，前往[联系我们](https://www.seemse.com)。
